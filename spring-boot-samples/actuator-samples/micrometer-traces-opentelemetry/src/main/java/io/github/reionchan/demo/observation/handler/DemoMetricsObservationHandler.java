...
import static io.github.reionchan.demo.observation.context.DemoContext.DEMO_METRIC_PREFIX;
...
@Slf4j
@Component
public class DemoMetricsObservationHandler implements MeterObservationHandler<DemoContext> {
