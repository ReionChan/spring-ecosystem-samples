...
/**
 * Micrometer OpenTelemetry Prometheus Grafana 整合观测指标数据启动器
 *
 * <pre>
 *
 * === OpenTelemetry 自动装配 ===
 ...
 * 2. Spring Boot Actuator 自动装配类 {@link OtlpMetricsExportAutoConfiguration}
 ...
 *  1.1 当前工作目录：
 *      ./actuator-samples/micrometer-metrics-opentelemetry
 *  1.2 在工作目录执行如下命令：
 *      启动：
...
public class MicrometerMetricsOpenTelemetryBootstrap {
    public static void main(String[] args) throws InterruptedException {
        ConfigurableApplicationContext ctx = SpringApplication.run(MicrometerMetricsOpenTelemetryBootstrap.class, args);
