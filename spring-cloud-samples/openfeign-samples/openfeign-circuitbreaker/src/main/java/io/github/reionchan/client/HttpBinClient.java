...
import outside.scan.config.HttpBinClientConfiguration;
...
//            fallback = HttpBinClientFallback.class,
            fallbackFactory = HttpBinClientFallbackFactory.class
)
public interface HttpBinClient {
     ...
     */
    @GetMapping("/{second:\\d+}")
    ResponseEntity<String> pathVar(@PathVariable("second") Integer second);
}
